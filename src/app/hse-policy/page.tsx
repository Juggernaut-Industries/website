...
const hseHighlights = [
  {
    ...
    description:
      "We strive for zero incidents, injuries, and illnesses across all our project sites.",
    icon: ShieldCheck,
  },
  {
    title: "Environmental Stewardship",
    description:
      "Commitment to protecting the environment and minimizing our ecological footprint.",
    icon: Leaf,
  },
  {
    title: "Safety Leadership",
    description:
      "Every employee is empowered to be a safety leader and stop any unsafe work.",
    icon: HeartPulse,
  },
  {
    title: "Compliance & Improvement",
    description:
      "Adherence to international standards and continuous improvement of our HSE system.",
    icon: FileText,
  },
];
        ...
        <div className="container-jil relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <ScrollReveal animation="fadeUp">
              ...
              <p className="text-steel-blue text-lg leading-relaxed">
                Safety is not a policy at Juggernaut it is a culture. Our HSE
                management system is built on global best practices, continuous
                staff training, and strict regulatory compliance. Across
                thousands of operational hours and multiple active sites, we
                have maintained a record free of major incidents and that is a
                standard we protect on every project we take on. Our people go
                home safe.
              </p>
            </ScrollReveal>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {hseHighlights.map((item, index) => (
              <ScrollReveal
                key={listKey(["hse-highlight", item.title])}
                animation="fadeUp"
                delay={0.1 * index}
              >
            ...
            <div className="lg:col-span-5 space-y-5">
              <ScrollReveal animation="fadeUp">
                <h2 className="font-display text-3xl md:text-4xl font-light leading-tight">
                  OFFICIAL <br />
                  <span className="text-industrial-gold font-semibold uppercase">
                    HSE STATEMENT
                  </span>
                </h2>
              ...
              <ScrollReveal animation="fadeUp" delay={0.1}>
                <div className="space-y-6 text-light-gray italic font-serif text-lg">
                  <p>
                    &ldquo;We are committed to providing a safe and healthy
                    workplace for all employees and contractors. We believe that
                    all workplace injuries are preventable and we work
                    tirelessly to achieve our goal of Zero Harm.&rdquo;
                  </p>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal animation="fadeUp" delay={0.2}>
                <div className="p-6 rounded-xl bg-steel-blue/10 border border-white/10 backdrop-blur-sm">
                  <p className="text-sm text-light-gray leading-relaxed mb-6">
                    Download the complete Health, Safety, and Environment Policy
              ...
              <ScrollReveal animation="fadeLeft" delay={0.3}>
                <div className="relative aspect-[3/4] md:aspect-[4/5] lg:aspect-auto lg:h-[800px] w-full bg-white/5 rounded-2xl border border-white/10 overflow-hidden shadow-2xl group">
                  ...
                  <div className="absolute inset-0 z-0 flex flex-col items-center justify-center p-8 text-center bg-deep-navy/40 lg:hidden">
                    ...
                    <p className="text-off-white font-heading text-sm uppercase tracking-widest mb-4">
                      Document Preview
                    </p>
                    <a
                      href={hsePolicyPdf}
            ...
            <div className="bg-deep-navy rounded-[2rem] p-8 md:p-16 relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-8 border border-white/5 shadow-2xl">
              ...
              <div className="relative z-10 text-center lg:text-left max-w-xl">
                ...
                <p className="text-light-gray">
                  Learn more about our core values and the team that drives our
