                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <Label
                          htmlFor="name"
                          className="block font-heading text-xs tracking-[0.1em] uppercase text-deep-navy mb-2"
                        >
                          Full Name *
                        </Label>
                        <Input
                    ...
                    <div>
                      ...
                      >
                        ...
                        <SelectContent className="bg-white border border-steel-blue/20 rounded-xl shadow-lg">
                          <SelectItem
                            value="mining"
                            className="text-deep-navy focus:bg-industrial-gold/10 focus:text-deep-navy cursor-pointer"
                          >
                            Mining & Exploration
                          </SelectItem>
                          <SelectItem
