            ...
            <div className="space-y-8 order-2 lg:order-1">
              ...
              <ScrollReveal animation="fadeUp" delay={0.1}>
                <p className="text-steel-blue leading-relaxed text-lg">
                  Juggernaut Industries Limited is driven by a team of dedicated
                  professionals with decades of experience operating in Nigeria.
                  Our people bring together diverse cultural perspectives and
                  specialised expertise, equipping the company to navigate
                  complex terrains and deliver consistently across challenging
                  environments.
                </p>
              </ScrollReveal>
